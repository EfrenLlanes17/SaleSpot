...
public class settings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BNV = findViewById(R.id.bottomNavView6);
        ...
        signOut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FollowingActivity.setFollowingProductList(temp);
                ForYouActivity.setForYouList(temp);
                ProfileActivity.setSavedList(temp);
                ProfileActivity.setFollowingList(temp2);
